...
urlpatterns = [
    ...
    path('pdtrating/<int:mid>',views.pdtrating,name="pdtrating"),  
    path('pdtajaxrating/',views.pdtajaxrating,name="pdtajaxrating"),
    path('pdtstarrating/',views.pdtstarrating,name="pdtstarrating"),
    path('Following/',views.Following,name="Following"),   
    path('AddWishList/<int:id>',views.AddWishList,name="AddWishList"),   

    path('wishlist/',views.wishlist,name="wishlist"),    
    path('remove_list/<int:id>',views.remove_list,name="remove_list"),
